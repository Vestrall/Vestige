...
public class OptionsScreen extends Screen implements WidgetListener
{
	...
	public OptionsScreen(AndroidGame game)
	{
        ...
        resetProgressButton = new Button(Screen.MIDX, 390, 401, 54, optionsStyle, "RESET LEVEL PROGRESS", SpriteManager.menuButton);
		resetProgressButton.addWidgetListener(this);
		resetProgressButton.setClickAnimation(SpriteManager.menuButtonClick);
		//resetProgressButton.setVisible(true);
        unlockAllButton = new Button(Screen.MIDX, 440, 401, 54, optionsStyle, "UNLOCK ALL LEVELS", SpriteManager.menuButton);
		unlockAllButton.addWidgetListener(this);
		unlockAllButton.setClickAnimation(SpriteManager.menuButtonClick);
