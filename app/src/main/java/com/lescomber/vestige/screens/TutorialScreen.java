...
public class TutorialScreen extends GameScreen implements GestureHandlerListener
{
	...
	private static final int CHAR_LIMIT_PER_LINE = 20;
	...
	@Override public void chargeSwipeBuilding(Line swipe) { }
	@Override public void handleTap(Point tapPoint) { }
	@Override public void swipeCancelled() { }
