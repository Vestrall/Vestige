...
public class GameScreen extends Screen implements WidgetListener
{
	...
	UISprite waveTextBackground;
	UISprite fpsTextBackground;
	...
	public GameScreen(AndroidGame game)
	{
		...
		final TextStyle pausedHeadingStyle = new TextStyle("Tommaso.otf", 83, 87, 233, 255);
		pausedHeadingStyle.setSpacing(2.5f);
