...
public class MainMenuScreen extends Screen implements WidgetListener
{
	...
	public MainMenuScreen(AndroidGame game, boolean introAnimation)
	{
		...
		{
			b.setClickAnimation(SpriteManager.menuButtonClickPieces);
		...
		newGameButtons[0] = new Button(Screen.MIDX, 231, BUTTON_WIDTH, BUTTON_HEIGHT, buttonStyle,
				res.getString(R.string.tutorial), SpriteManager.menuButtonPieces);
		newGameButtons[1] = new Button(Screen.MIDX, 288, BUTTON_WIDTH, BUTTON_HEIGHT, difficultyStyle,
				res.getString(R.string.easy), SpriteManager.menuButtonPieces);
		newGameButtons[2] = new Button(Screen.MIDX, 344, BUTTON_WIDTH, BUTTON_HEIGHT, difficultyStyle,
