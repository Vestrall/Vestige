...
public class CGLTexturedRect extends CGLDrawingRect {
	private static final String VERTEX_SHADER_CODE = "uniform mat4 u_mvpMatrix;" +    // model/view/projection matrix
	...
	private static final String FRAGMENT_SHADER_CODE = "precision mediump float;" +        // medium is fine for texture maps
	...
	public CGLTexturedRect(int textureHandle, float x, float y, int texWidth, int texHeight) {
