...
public class MobileEntity extends Entity {
	private Point destination;    // Current destination this MobileEntity is moving towards
	...
	/**
	 * Determine x and y distances traveled per ms. Use this info to update frame destination each frame (in order to avoid trig calculations every
	 * frame)
	 */
	...
	/**
	 * Triggered when current destination has been reached
	 */
