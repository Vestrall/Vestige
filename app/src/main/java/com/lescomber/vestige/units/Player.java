...
public class Player extends Unit implements GestureHandlerListener
{
	...
	public boolean isSwipeQueued() { return swipeQueue != null; }
	public boolean isChargeSwipeQueued() { return chargeSwipeQueue != null; }
	public boolean isChargeSwipeReady() { return chargeSwipeAbility.getCooldown() <= 0; }
