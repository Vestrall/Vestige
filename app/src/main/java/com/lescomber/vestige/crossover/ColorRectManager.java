...
public class ColorRectManager
{
	...
	public synchronized static int newColorRect(float x, float y, float width, float height,
	...
	public synchronized static void replaceColorRect(int list, int index, float x, float y, float width, float height,
													float r, float g, float b, float a)
	{
