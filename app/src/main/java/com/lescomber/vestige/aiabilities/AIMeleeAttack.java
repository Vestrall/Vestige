...
public class AIMeleeAttack extends AIAbility
{
	...
	public AIMeleeAttack(AIUnit owner, float damage, double cooldownSeconds/*, boolean scaleForDifficulty*/)
	{
	...
	public void setHitSound(SoundEffect hitSound) { hitBundle.setHitSound(hitSound); }
