...
public abstract class RectangleObstacle extends Entity implements Obstacle
{
	...
	public RectangleObstacle(float left, float top, float right, float bottom)
	{
		...
		pathRect = new Rectangle(wallRect.left - Map.PLAYER_HALF_WIDTH, wallRect.top - Map.PLAYER_HALF_HEIGHT,
								wallRect.right + Map.PLAYER_HALF_WIDTH, wallRect.bottom + Map.PLAYER_HALF_HEIGHT);
	}
	...
	@Override
	public List<BoundaryLine> getBoundaryLines() { return boundaryLines; }
