...
public abstract class Ability
{
	...
	public void setSoundEffect(SoundEffect soundEffect) { this.soundEffect = soundEffect; }
	public void setMaxCooldown(double cooldownSeconds) { maxCooldown = (int)(cooldownSeconds * 1000); }
	public void setCooldown(double cooldownSeconds) { cooldown = (int)(cooldownSeconds * 1000); }
	public void triggerCooldown() { cooldown = maxCooldown; }
