...
public class StatusEffect
{
	...
	private boolean removeOnNoEffect;	// If true, remove this StatusEffect when it no longer has a statistical effect (e.g. this
										//effect is a shield that has been consumed)
	private int stacks;
	...
	// Returns true if the number of stacks (and therefore possibly the stats provided by this StatusEffect) has changed
	...
	public StatPack getStats() { return stats; }
	public int getDuration() { return duration; }
	public SpriteAnimation getAnim() { return anim; }
	public boolean isFinished() { return (stacks <= 0 || noEffect()); }
	
	public void setDuration(int duration) { this.duration = duration; }
	public void setNoEffectRemoval(boolean removeOnNoEffect) { this.removeOnNoEffect = removeOnNoEffect; }
	public void setStats(StatPack stats) { this.stats = stats; }
	public boolean noEffect() { return removeOnNoEffect && stats.isEmpty(); }
