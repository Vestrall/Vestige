...
public class CopyOfBeamSprite extends Sprite
{
	...
	public CopyOfBeamSprite(CopyOfBeamSprite copyMe)
	{
		super(copyMe);
	...
	@Override public void setTexWidth(float percentage) { }		//Note: setTexWidth doesn't work for BeamSprite
	
	@Override public float getX() { return x; }
	@Override public float getY() { return y; }
	@Override public float getDirection() { return bodySprite.getDirection(); }
	@Override public int getIndex() { return bodySprite.getIndex(); }
	@Override public SpriteInfo getInfo() { return bodySprite.getInfo(); }
	@Override public Sprite getSprite() { return bodySprite; }
	@Override public SpriteTemplate getTemplate() { return bodySprite.getTemplate(); }
	...
	@Override public float getSubTexWidth() { return 0; }		// Doesn't work
	@Override public float getSubTexHeight() { return 0; }		// Doesn't work
	...
	@Override public boolean isVisible() { return bodySprite.isVisible(); }
	...
	@Override
	public CopyOfBeamSprite copy()
	{
		return new CopyOfBeamSprite(this);
	}
}