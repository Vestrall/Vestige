...
public class Projectile extends MobileEntity
{
	...
	public boolean wallPassThrough() { return wallPassThrough; }
	public boolean unitPassThrough() { return unitPassThrough; }
	public boolean arrivalRemoval() { return arrivalRemoval; }
	public boolean getOffScreenRemoval() { return offScreenRemoval; }
	...
	public void disableGlow() { if (glow != null) glow.close(); glow = null; }
	public void setAreaEffect(AreaEffect areaEffect) { this.areaEffect = areaEffect.copy(); }
	public void setExplosion(Explosion explosion) { this.explosion = explosion.copy(); }
	public void setExplosionSound(SoundEffect explosionSound) { this.explosionSound = explosionSound; }
	...
	public void setUnitPassThrough(boolean unitPassThrough) { this.unitPassThrough = unitPassThrough; }
	public void setArrivalRemoval(boolean arrivalRemoval) { this.arrivalRemoval = arrivalRemoval; }
	public void setOffScreenRemoval(boolean offScreenRemoval) { this.offScreenRemoval = offScreenRemoval; }
	...
	public void setDamage(float damage) { hitBundle.setDamage(damage); }
	public void setTargets(int targetFaction) { targets.clear(); targets.add(targetFaction); }
	public void addTargets(int targetFaction) { if (!targets.contains(targetFaction)) targets.add(targetFaction); }
	public void setHitGroup(HitGroup hitGroup) { this.hitGroup = hitGroup; }
	public void setHitAnimation(SpriteAnimation anim) { hitBundle.setHitAnimation(anim); }
	public void setUnitHitSound(SoundEffect unitHitSound) { hitBundle.setHitSound(unitHitSound); }
	public void clearHitList() { unitsHit.clear(); }
	public void addStatusEffect(StatusEffect effect) { hitBundle.addStatusEffect(effect); }
	public void setDisplacementEffect(DisplacementEffect de) { hitBundle.setDisplacementEffect(de); }
