...
public class Button extends Widget
{
	...
	public Button(float x, float y, TextStyle style, String text, SpriteTemplate template)
	{
		...
		// Base width/height on sprite's native width/height
		if (template != null)
		{
		...
		// ...or base width/height on size of text if no sprite
	...
	public void setClickSound(SoundEffect clickSound) { this.clickSound = clickSound; }
	public SoundEffect getClickSound() { return clickSound; }
	...
	public float getX() { return rect.getCenterX(); }
	public float getY() { return rect.getCenterY(); }
	
	/*public void setImage(UISprite sprite)
	{
	...
	public RotatedRect getRect() { return rect; }
	
	public void setListenedEvent(int eventType) { listenedEvent = eventType; }
