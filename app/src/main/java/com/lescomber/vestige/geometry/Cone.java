...
public class Cone extends Shape {
	...
	public boolean overlaps(Cone cone) {
		...
		if (Angle.isInRange(connectAngle, direction - halfWidth, direction + halfWidth) && Angle
				.isInRange(connectAngle + (float) Math.PI, cone.direction - cone.halfWidth, cone.direction + cone.halfWidth))
			return true;
	...
	/**
	 * Note: only updates the position/size of boundingBox when it is requested via getBoundingBox()
	 */
	@Override
